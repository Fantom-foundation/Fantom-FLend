...
import "../interfaces/IFLendAddressProvider.sol";

/**
* This contract provides addresses to all the deployed
* FLend modules and related contracts, which cooperates
* in the FLend protocol. It's used to connects different
* modules to make the whole FLend protocol live and work.
*
* @version 0.1.0
* @license MIT
* @author Fantom Foundation, Jiri Malek
*/
contract FLendAddressProvider is Ownable, IFLendAddressProvider {
